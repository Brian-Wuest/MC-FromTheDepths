...
{
	private static final ResourceLocation structureTopDown = new ResourceLocation("from_the_depths", "textures/gui/chicken_coop_top_down.png");
	...
	public void drawScreen(int x, int y, float f) 
	{
		...
		// Draw the text here.
		if (!FromTheDepths.proxy.proxyConfiguration.enableStructurePreview)
		{
