package com.wuest.from_the_depths.Gui.Structures;
...
{
	public final ResourceLocation backgroundTextures = new ResourceLocation("from_the_depths", "textures/gui/default_background.png");
	public BlockPos pos;
	...
	protected void performCancelOrBuildOrHouseFacing(StructureConfiguration configuration, GuiButton button) throws IOException
	{
		...
		{
			FromTheDepths.network.sendToServer(new StructureTagMessage(configuration.WriteToNBTTagCompound(), this.structureConfiguration));
			this.mc.displayGuiScreen(null);
		}
