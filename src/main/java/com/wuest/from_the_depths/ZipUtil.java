...
public class ZipUtil
{
	...
	{
		InputStream stream = FromTheDepths.class.getClassLoader().getResourceAsStream(resourceLocation);
		String temp;
	...
	public static BufferedImage decompressImageResource(String resourceLocation)
	{
		...
		try
		{
			...
			// The file has been de-compressed, convert those bytes to a BufferedImage.
