package com.wuest.from_the_depths.StructureGen.CustomStructures;
...
import com.wuest.from_the_depths.StructureGen.BuildClear;
...
{
	public static final String ASSETLOCATION = "assets/from_the_depths/structures/chickencoop.zip";
	...
	public static void ScanStructure(World world, BlockPos originalPos, EnumFacing playerFacing)
	{
		...
		Structure.ScanStructure(
				...
				"..\\src\\main\\resources\\assets\\from_the_depths\\structures\\chickencoop.zip",
				clearedSpace,
